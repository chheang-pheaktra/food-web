...
@section('contents')
    <section class="pt-10   content-center h-full overflow-hidden mt-10 bg-gray-50 md:pt-0 sm:pt-16 2xl:pt-16 item-center">
            ...
            <div class="grid items-center grid-cols-1 md:grid-cols-2">
                ...
                <div>
                    <h2 class="text-3xl font-bold leading-tight text-black sm:text-4xl lg:text-5xl">Hey 👋 I
                        am
                        <br class="block sm:hidden" />Developer
                    </h2>
                ...
                <div class="relative">
                    ...
                    <img class="relative w-full xl:max-w-lg xl:mx-auto 2xl:origin-bottom 2xl:scale-110" src="{{asset('asset/about-us.gif')}}" alt="" />
                </div>
