                ...
                <div class="flex h-full w-full space-x-3 overflow-hidden md:justify-end lg:px-2">
                    ...
                    <div class="my-auto mb-10 hidden w-56 flex-col space-y-3 md:mt-36 lg:flex">
                        <div class="rounded-xl bg-yellow-400 pt-10">
                            <img class="h-full w-full object-contain" src="{{asset('/asset/pic3.png')}}" alt="" />
                        </div>
                    </div>
                ...
                <div
                    ...
                    <a class="flex w-full items-center rounded-xl border border-black border-opacity-10 px-4 py-6 text-black duration-200 hover:border-opacity-0 hover:no-underline hover:shadow-lg  sm:flex-col sm:hover:shadow-2xl"
                       href="#" target="_blank">
                        ...
                        <div>
                            <div class="font-semibold text-black  sm:mt-4 sm:mb-2">Drink</div>
                    ...
                    <a class="flex w-full items-center rounded-xl border border-black border-opacity-10 px-4 py-6 text-black duration-200 hover:border-opacity-0 hover:no-underline hover:shadow-lg  sm:flex-col sm:hover:shadow-2xl"
                       href="#" target="_blank">
                        ...
                        <div>
                            <div class="font-semibold text-black  sm:mt-4 sm:mb-2">Foods</div>
                    ...
                    <a class="flex w-full items-center rounded-xl border border-black border-opacity-10 px-4 py-6 text-black duration-200 hover:border-opacity-0 hover:no-underline hover:shadow-lg  sm:flex-col sm:hover:shadow-2xl"
                       href="#" target="_blank">
                        ...
                        <div>
                            <div class="font-semibold text-black  sm:mt-4 sm:mb-2">Vegetable</div>
